    ...
    <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="font-medium text-slate-900 dark:text-white mb-1">{user?.name ?? "..."}</p>
      ...
      <div className="p-6 rounded-2xl bg-white/60 dark:bg-white/5 border border-white/20 dark:border-white/10 backdrop-blur-xl">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 p-4 rounded-xl bg-slate-900 dark:bg-white/10 text-white hover:bg-slate-800 dark:hover:bg-white/20 transition-all"
        >
